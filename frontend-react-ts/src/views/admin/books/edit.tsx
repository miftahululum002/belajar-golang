...
import { useBookUpdate } from '../../../hooks/book/useBookUpdate';
...
const ProductEdit: FC = () => {
    ...
    // inisialisasi useBookById
    const { data: book } = useBookById(Number(id));
            ...
            <div className="row">
                ...
                <div className="col-md-9">
                    <div className="card border-0 rounded-4 shadow-sm">
                        <div className="card-header">Ubah Data Buku</div>
